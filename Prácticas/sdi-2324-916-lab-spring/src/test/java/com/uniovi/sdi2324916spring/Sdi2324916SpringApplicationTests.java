package com.uniovi.sdi2324916spring;

import com.uniovi.sdi2324916spring.pageobjects.*;
...
class Sdi2324916SpringApplicationTests {
    static String PathFirefox = "C:\\Program Files\\Mozilla Firefox\\firefox.exe";
    static String Geckodriver = "C:\\Users\\eric_\\OneDrive - Universidad de Oviedo\\UNIOVI\\2022-2023\\Sistemas Distribuidos e Internet\\Practicas\\Sesión 5\\PL-SDI-Sesión5-material\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
    ...
    void PR01B() {
        ...
        assertEquals(welcomeMessageElement.get(0).getText(),
...
// Propiedad: Error.signup.dni.length
    ...
    void PR09() {
        PO_HomeView.clickOption(driver,"login","class","btn btn-primary");
        PO_LoginView.fillLoginForm(driver,"99999988F","1234566");
        String checkText = "Identifícate";
        List<WebElement> result = PO_View.checkElementBy(driver, "h2", checkText);
        Assertions.assertNotEquals(checkText, result.get(0).getText());
    }
    @Test
    @Order(11)
    void PR10() {
        PO_HomeView.clickOption(driver,"login","class","btn btn-primary");
        PO_LoginView.fillLoginForm(driver,"99999990A","1234566");
        String checkText = "Identifícate";
        List<WebElement> result = PO_View.checkElementBy(driver, "h2", checkText);
        Assertions.assertNotEquals(checkText, result.get(0).getText());
    }
    ...
    public void PR012_15() {
        ...
        // Comprobar que se ha accedido a la página privada del alumno
        assertTrue(PO_PrivateView.isInPrivateView(driver));

        // Verificar que se muestran las notas del usuario
        List<WebElement> marksList = PO_PrivateView.getMarkElements(driver);
        assertEquals(2, marksList.size());

        // Desconectarse y verificar que se muestra el menú de registro
...
//P14. Esta prueba podría encapsularse mejor ...
    ...
    public void PR14() {
        ...
        assertEquals(checkText, elements.get(0).getText());
